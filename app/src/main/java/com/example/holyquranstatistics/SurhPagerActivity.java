...
public class SurhPagerActivity extends AppCompatActivity {
    ...
    public static Intent newIntent(Context packageContext, UUID Id, String surhID , String surhName, String surhayhNumbers , String startSurhFrom) {
  ...
  //      intent.putExtras(bundle);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
       ...
       UUID SID = (UUID) getIntent().getSerializableExtra(EXTRA_ID);
     //  String SID = (String) getIntent().getSerializableExtra(EXTRA_ID);
        ...
        for (int i = 0; i < mQurans.size(); i++) {
            if (mQurans.get(i).getId().equals(SID) ){
                ...
                Log.e("Pager", "onCreate: " + mQurans.get(i).getId());
                break;
            }
        }
